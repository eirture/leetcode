# [2228. 给植物浇水 II](https://leetcode.cn/problems/watering-plants-ii/) - medium
...
一个简单的思路，两个指针 a，b，左右每次各往中间走一步。每次判断 va，vb 记录 Alice 和 Bob 水壶中的水。比较植物需要的水，如果需要加水则计数 +1。直到 a == b。
...
func minimumRefill(plants []int, capacityA int, capacityB int) int {
    ...
    if a == b && va < plants[a] && vb < plants[b] {
        n++
    }
    return n
}
